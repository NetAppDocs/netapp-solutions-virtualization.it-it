...
|===
| Protocollo di archiviazione | direzione | fs | netfs | logico | disco | iscsi 


| iscsi-diretto | mpath | PMI/CIFS | SÌ | NO | SÌ | NO 


| NO | NO | NO | NO | NFS | SÌ | NO 
|===
...
[cols="40%, 20,% 20%, 20%"]
|===
| Protocollo di archiviazione | Fedora | Debian 


| Pac-Man | PMI/CIFS | samba-client/cifs-utils 


| smbclient/cifs-utils | smbclient/cifs-utils | NFS 


| nfs-utils | nfs-comune | nfs-utils 
|===
