...
Per ulteriori informazioni sulla creazione di policy fare riferimento a https://docs.netapp.com/us-en/bluexp-backup-recovery/task-create-policies-vms.html["Creare una policy per eseguire il backup degli archivi dati"] .
...
Per maggiori informazioni fare riferimento a https://docs.netapp.com/us-en/bluexp-backup-recovery/task-backup-vm-data-to-aws.html["Eseguire il backup degli archivi dati su Amazon Web Services"] .
...
Per maggiori informazioni fare riferimento a https://docs.netapp.com/us-en/bluexp-backup-recovery/task-restore-vm-data.html["Ripristina i dati delle macchine virtuali dal cloud"] .
