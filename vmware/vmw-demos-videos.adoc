...
[%collapsible%open]
====
Le soluzioni di protezione dei dati 3-2-1 combinano backup primari e secondari in sede, utilizzando la tecnologia SnapMirror , con copie replicate su storage di oggetti tramite NetApp Backup and Recovery.
