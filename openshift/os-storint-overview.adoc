...
Trident, un provider e orchestratore di storage open source gestito da NetApp e NetApp Trident Protect ti aiuta a orchestrare e gestire dati persistenti in ambienti basati su container, come Red Hat OpenShift.
