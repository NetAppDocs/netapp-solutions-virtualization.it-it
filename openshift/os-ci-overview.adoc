...
Per iniziare a utilizzare Cloud Insights, è necessario registrarsi su link:https://www.netapp.com/console["NetApp Console"]. Per i dettagli, fare riferimento al link:https://docs.netapp.com/us-en/cloudinsights/task_cloud_insights_onboarding_1.html["Integrazione Cloud Insights"]
