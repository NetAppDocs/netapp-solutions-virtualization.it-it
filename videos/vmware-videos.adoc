...
summary: 'Video e demo che mostrano l"integrazione delle soluzioni VMware con le tecnologie di storage NetApp' 
keywords: vmware, vsphere, vcf, snapcenter, ontap tools, videos, demos 
---
= Guarda i video sulla virtualizzazione VMware con NetApp
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Guarda video e demo che illustrano l'integrazione di VMware con le soluzioni di storage NetApp . Scopri come utilizzare NetApp ONTAP Tools per VMware vSphere, il SnapCenter Plug-in for VMware vSphere, la protezione dei dati 3-2-1 e come NetApp interagisce con VMware Cloud Foundation e VMware vSphere Foundation.



== Provisioning del datastore VMware con ONTAP
...
.Protezione dei dati 3-2-1 per datastore VMFS con SnapCenter Plug-in for VMware vSphere e NetApp Backup and Recovery per macchine virtuali
...
.Datastore NFS come storage principale per domini di carico di lavoro VCF
video::9b66ac8d-d2b1-4ac4-a33c-b16900f67df6[panopto]
.Datastore iSCSI come storage supplementare per i domini di gestione VCF
