...
NOTE: La configurazione desiderata per i dispositivi ONTAP multipath è già inclusa nel pacchetto. Per ulteriori informazioni, fare riferimento a link:https://docs.netapp.com/us-en/ontap-sanhost/hu-proxmox-ve-9x.html#step-1-confirm-the-multipath-configuration-for-your-host["Documentazione ONTAP 9 su Proxmox VE 9.x per FCP e iSCSI con storage ONTAP"]
